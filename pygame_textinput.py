'''
	Directly from https://github.com/Nearoo/pygame-text-input:

The program draws its own cursor as a blinking
rectangle and allows one to save user input
upon pressing enter (inside pygame event loop).
'''
